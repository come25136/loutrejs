...
| invalid variationの静的診断                                                                                            | `compiler.test.ts`、`http-auth.integration.test.ts`、type-level tests                                                  |
| 複数runtimeの同一fixture conformance                                                                                   | `runtime-conformance.integration.test.ts`と`conformance/`内の実runtime runner                                          |
